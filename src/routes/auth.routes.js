...
import { registerUser, loginUser, logOutUser, updateUser, refreshAccessToken, getUser } from "../controllers/auth.controller.js";
...
const router = Router();
router.get("/me",gentleRateLimit,verifyToken,getUser)
